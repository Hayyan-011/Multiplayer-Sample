...
var ASM_CONSTS = {
  3736128: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3736183: function($0) {performance.now = function() { return $0; };},  
 3736231: function($0) {performance.now = function() { return $0; };},  
 3736279: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3736334: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3736395: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3736459: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _PhotonVoice_WebAudioAudioOut_Start(handle, sampleRate, channels, bufferSamples, spatialBlend, refDistance, maxDistance) {
          if (!Module.PhotonVoice_WebAudioAudioOut_Global) {
